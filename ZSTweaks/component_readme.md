...
- **Spears**: Base damage is increased from 1d6 to 1d8. This also affects javelins from Project Javelin, increasing their thrown damage die by 2.
...
- Wand of Fear: Fear effect duration is reduced from 15 rounds to 1 turn, the undocumented +2 save bonus is removed, and it is therefore as effective as the Horror spell or the War Cry HLA.
- Wand of Paralysis: Effect duration is reduced from 1 turn to 7 rounds.
- Wand of Sleep: The description now notes that it only works on monsters of up to 4 HD.
...
Additionally, these spells provide a very brief immunity to poison effects after taking effect: half a round for Slow Poison, and 1 round for Neutralize Poison.

### Make jewelry more valuable (1538) (IWDEE BGEE BG2EE EET)

This improves the value of all necklaces, rings, and gems that are not magical in nature (no passive or active traits of any sort). The component increases the value of those by 50% by default. However, this percentage is fully customizable. Check the ZSTweaks/configurations/**zstweaks_prefs.txt** file if you want to customize this.
...
Inspired by 2nd Edition rules, this component prevents vorpal hits from affecting targets protected by Stoneskin or Ironskins.
...
- A retaliatory effect: Undead that attack the user are rebuked, take 1d4+1 magic damage, and are panicked (as if turned) for 2 rounds (Save vs. Spell for half damage and to negate fear).

### Make everyone able to perform omnidirectional backstabs (1600) (IWDEE BGEE BG2EE EET)

This allows player-created characters as well as all joinable characters to backstab from any angle. Optionally, you can instead allow them to backstab without invisibility, while keeping the angle requirement intact.
...
I do not like gear that can be worn without any effect whatsoever. I can live with rings being purely cosmetic, since there is no obvious practical benefit to simply wearing one. For that reason, unenchanted belts, boots, and bracers now grant the wearer +1 HP. I think this is reasonable, changes balance very little, and gives even mundane versions a purpose. For consistency, the magical variants also grant that bonus. The unenchanted items will still be the weakest choice, but this should encourage filling those gear slots.
...
- The on-equip strength-sapping effect no longer affects undead (such as Hexxat).
...
This is clearly a mistake, since Shadow Dragons do not use acid as a breath weapon. Instead, it offers Negative Plane Protection, Non-Detection, and a +4 bonus to saves vs. Illusion and Necromancy spells.

### Make Silver Dragon Scale also grant 40% cold resistance (1171) (BG2EE EET)

The reason is that Silver Dragons breathe and are resistant to cold.
...
This makes the ring significantly more useful for an Archdruid, adding one extra spell slot at each spell level and a slow regeneration effect befitting the nigh-timeless druidic legend you are.
...
- **Traveler's Robe**
  - +3 Armor Class against missiles (was +1)
...
- **Adventurer's Robe**
  - +1 Armor Class bonus (the bonus to crushing seems a little weird)
...
Creating 6 darts is really unremarkable for a once-per-day effect. 30 is far more interesting. Additionally, while worn, it grants one extra proficiency point in darts and a +2 bonus to Save vs. Spell.

### Make Eyes of the Beholder better and grant immunity to matching rays (1570) (BG2EE EET)

This improves the helm slightly such that the Domination power is as powerful as the Domination spell, i.e., a -2 penalty to Save vs. Spell, and the Paralyze power is as powerful as the wizard version of Hold Person, i.e., a -1 penalty to Save vs. Spell. Additionally, the helmet makes the wearer immune to beholder rays that cause the same effects; that is, you cannot be paralyzed, charmed, or panicked by beholder rays.
...
### Make Grandmaster's Armor better and grant perks to backstabbers (1652) (BG2EE EET)
...
Self-explanatory. As for the reasoning, it felt odd to leave acid breath out of it. The bonus to Saves vs. Breath is there because, well, dragon breath.
...
This makes the cloak more meaningful for Rangers, granting them a +1 bonus to THAC0 and damage.
...
### Make ioun stones and/or circlets protect vs. critical hits (1664) (BGEE BG2EE EET)
...
- Circlet of Netheril: This makes it more useful and fitting for sorcerous classes by adding one extra level 9 spell slot, as well as a +7% bonus to magic damage dealt
- Eilistraee's Boon +1: Non-evil elves get +1 DEX

### Make Bracers of Blinding more generally useful for everyone (1666) (BG2EE EET)
...
I decided to take the name of the item more seriously. And let's face it, this item is almost always an automatic sell. In this state, at least it has some use for Fighter/Thieves or Cleric/Thieves: +10% to both Detect Illusions and Find Traps.
...
### Make Senses of the Cat imbue the user with more cat-like features (1678) (IWDEE BGEE BG2EE EET)

Cats forever! It now improves Armor Class by 1, adds a +4 bonus against missiles, grants a +1 bonus to Saves vs. Breath, and increases movement rate by a factor of 3.
...
- +2 Armor Class, and an additional +4 Armor Class against missiles
- Immunity to level 1, 2, and 3 spells
- +2 to Saving Throws (vanilla)
...
- Shadow Dragon Wardstone: It is now an ioun stone that grants immunity to Blindness. Shadow dragons and other shadow creatures suffer a -2 penalty to attack rolls against the wearer. It also grants +5% to stealth skills, while Shadowdancers and Dark Moon Monks gain +3% physical damage resistance.

All of these can be toggled on and off in the preferences file.
...
This follows the same philosophy as the tweak to beetle creatures. The armor now provides 18% resistance to missiles, 12% to slashing, and the Armor Class was tweaked to reflect this theme.

The shield does the same, providing 12% resistance to missiles, 8% to slashing, and 5% to piercing. It also provides a +1 Armor Class bonus against piercing.
...
Following the Umberlee theme, this armor now provides 20% resistance to cold and electricity. Additionally, it provides an 18% chance to inflict 1d4 cold and electric damage with each successful melee or ranged attack made by the wearer.
...
- Other saves: +1
- Poison resistance: -50%. **Bear in mind this weakness will likely not work without the Fixpack installed**.
...
Generally, this robe was never very convenient to use, especially considering the alternatives, even without Chaos Shield. So now it undoes the -1 Armor Class penalty, becoming an actual Armor Class bonus that can be combined with a good pair of bracers, and adds +1 casting speed for Wild Mages only.
...
This will probably not be a favorite for powergamers, since the robe is effectively "the best" in vanilla, but I decided to make it more nuanced, with some functional inspiration from NWN. It is now the Robe of Larloch rather than Vecna, since that feels more lore-appropriate to begin with, and Larloch is also a lich of immense power. Here are the changes:
...
- Enemies killed while wearing the armor grant the wearer +1 THAC0 and +1 damage for 7 seconds
- May be worn by thieves and bards, and does not disable thieving abilities

### Make Cowl of the Stars more useful (1336) (BG2EE EET)
...
Finally, it has a charge ability usable twice per day called Heavenly Strike, which causes a lightning bolt to fall from the sky, dealing 6d6+24 electrical damage (Save vs. Breath at -5 to take three quarters of the damage), followed shortly by a column of fire that deals 6d6+24 fire damage (Save vs. Breath at -5 to take three quarters of the damage). The fire spreads to enemies standing too close to the impact point, dealing 60% of the potential fire damage. Using this ability also empowers the wielder's attacks for 1 turn, causing them to deal +2 fire and electrical damage per hit.
...
This component changes the healing to a probability-based system: a 50% chance to heal 1 HP, a 20% chance to heal 2 HP, a 15% chance to heal 3 HP, a 10% chance to heal 4 HP, and a 5% chance to heal 5 HP. Additionally, there is now a 15% chance for the stun effect to trigger as well, but only if a Save vs. Spell is failed (the vanilla 5% chance allows no Saving Throw). All effects now bypass Magic Resistance, which is probably an oversight in the original implementation.
...
This component makes the weapon try to stun the victim with a 25% probability instead of 20%. Inspired by the sadistic story behind the weapon, it now has a 5% higher critical hit chance, and it also causes bleeding on every hit, similar to Gnasher, inflicting 2 extra piercing damage immediately, as well as 2 more per round for 3 rounds.
...
- 33% chance to cause an additional 1d4+2 magic damage
...
It seems appropriate that the talking sword containing a blood-lusting, raving, screaming lunatic can cause confusion on hit. It now has a 25% chance to cause confusion on hit for 1 round if a Save vs. Spell is failed.

### Make Warblade slightly more unique and potent when used by barbarians (1202) (BG2EE EET)

Since this was blessed by northern barbarian gods, the sword now causes 1d4 cold damage on contact, while also changing the sword's base damage to 1d12+2 (keep reading, don't worry). Barbarians wielding this sword receive +5% physical resistance, and the sword's bonus damage is increased by 3 (1d12+5). Lastly, it is renamed "Barbarian Warblade +4", just because.
...
Additionally, since the dispel-on-hit effect is pretty cheesy, a Save vs. Spell is added as a counterbalance: no penalty with the +5 version, and -2 with the +6 version. As for the ability to cast Dispel Magic, since level 15 dispel is quite weak, especially for the +6 version, it is now cast at level 20 or 30 depending on the version.
...
- Wielding it makes the user immune to mind blasts and domination attempts by mind flayers
- Critical hits cause 2d8 psychic (irresistible) damage and cause Confusion for 10 seconds if a Save vs. Spell at -2 is failed. Creatures without minds or brains are unaffected.
- Speed factor of 6

### Make Flame of the North able to kill trolls and affect all evil (1318) (BG2EE EET)

Self-explanatory. Also, the backstory of the sword heavily implies that it was involved in the slaughter of many trolls. Therefore, the sword can now completely destroy trolls on hit by dealing +2 fire damage to trolls only.

### Make Staff of the Magi more balanced (1390) (BG2EE EET)

Staff of Magi is a little silly for two main reasons:

- Always dispels on every hit
...
- The dispel-on-hit effect only works if the target fails a Save vs. Spell at -2
- The invisibility-on-equip effect now only affects a given user at most once per turn
...
This is essentially the same tweak as the one for Carsomyr, except the chance of dispelling is also 100%. The Save vs. Spell has no penalty. It also changes the weapon's base damage to 1d12, much like Carsomyr, tightening the resemblance between both swords. Both features are optional.

### Make Spear of Withering able to poison on contact (1460) (BG2EE EET)

I feel like this spear should be more withering, especially considering that it is a +4 weapon. This makes the spear able to inflict 12 extra poison damage over 1 round if a Save vs. Death at -2 is failed.

### Make Wave slightly more powerful (1540) (BG2EE EET)
...
Soul Reaver is fairly unbalanced, particularly because it reduces THAC0 by 2 cumulatively for 2 full minutes, making it fairly easy to render an enemy unable to hit anything at all. This tweak reduces that duration to 5 rounds and requires a Save vs. Spell at -4 to resist. It also now deals 1d12 slashing damage (or 2d6 if the two-handed general tweak was installed). Both changes are optional.
...
Another example of a highly enchanted weapon without any special property. I based this tweak on the description, which is horrific but inspiring. Therefore:
...
- Special ability: **Witch's Wrath** once per day. It works as a Sunfire that causes 8d6+10 fire damage to all enemies around the caster without affecting party members. The damage is increased by 4d6+10 if the target is affected by Panic. The explosion itself also causes Horror and Slow for 3 rounds unless a Save vs. Spell at -2 is made.
...
This weapon, similarly to The Equalizer, deals unenchanted damage by default and adds its bonus damage separately. For the purposes of multipliers, that makes it a noticeably weaker halberd than other +4 halberds, despite the added multi-elemental +5 damage per hit. This makes the weapon's base damage truly 1d10+4, with the extra damage intact. If that is acceptable for the Flail of Ages +5, it is acceptable for this too.
...
- In addition to +2 cold damage, it has a chance to unleash an extra 1d6 cold damage if the target fails a Save vs. Death
- Every hit has a 25% chance to reduce Strength by 2 for 5 rounds. This cannot kill the target. If the target's Strength is already below 3, it instead drains 2 Constitution, which can kill the target (though that would still be fairly difficult to pull off given the 5-round duration).

### Make the Ravager halberd more balanced (1606) (BG2EE EET)

I hate this 10% chance of killing, period-no-questions-asked effect with a passion, so:
...
- Poison is underrepresented and, as such, its minimum damage has been increased:
...
- The upgraded version now becomes +6, matching the maximum damage of Warblade +4 and becoming the most powerful damaging two-handed sword per hit in the 1d10 range
- Passive +5% MR is now +10% (it has to compete with Carsomyr, so 5% for a two-handed weapon is nonsense)
- The 1-level drain per hit on the upgraded version, with its -5 save penalty, is fairly inconsequential by the time you get it (from Abazigal's corpse). Instead, it causes affected creatures to deal 20% less damage for 2 rounds, representing a weakening effect, with a Save vs. Death at -5 to resist. This also affects magical and elemental damage. It does not stack.
...
The weapon now has a 5% higher critical hit chance, and critical hits deal +5 piercing damage.
...
- On hit, restores 1-6 Hit Points, randomly determined. The lower the healing, the more likely it is to trigger.
...
- None of these effects trigger on targets protected by Stoneskins.
- It glows.
- Ascension's +4 version also gets the exact same additions, replacing that mod's version of its on-hit effects (though it does not touch the effect that causes anyone other than Sarevok to suffer penalties with each hit). It also fixes text-format inconsistencies that make it look out of place compared to other EE items, as well as item issues such as not having the speed factor of a +4 weapon. It also removes unnecessary stat restrictions, such as requiring a certain level of Intelligence or Constitution.
...
This makes the sword usable by non-monks of any alignment. Additionally, it now has a speed factor of 0 and inflicts 1 point of poison damage on hit. For Monks only, it also grants +5% critical hit chance while held, as well as a +2 THAC0 bonus, including for off-hand attacks.
...
Peridan's description is slightly misleading because it states that it does "double damage to dragons." You might think that every time you damage a dragon with it, the same damage is dealt again, or perhaps that every attack simply deals twice as much damage as it would against other enemies, like a critical hit. That is not quite how it works.

In reality, the sword deals 1d8+2 against all enemies, and against dragons it deals another 1d8+2 in a second damage tick that is not affected by Strength modifiers. So now the description is more explicit about what it does, and:

- Regeneration improved to 1 HP per 15 seconds
...
Honestly, it kind of feels immediately not useful by the time you get it. The description is also slightly misleading because it looks like it will deal, for example, 1d8+6 against some alignments in the same way a +6 long sword would, but that is not how it works. It actually inflicts 1d8 damage, like a normal non-magical sword, and then adds the bonus damage separately, which is generally much less powerful. Therefore, the following improvements now exist:

- The sword now has an enchantment of 5 for the purposes of what it can hit and in terms of speed factor.
- The sword acts as a 1d8+3 weapon in all other respects as a baseline.
...
- The sword now also grants passive improvements depending on alignment, benefitting the most those that are neutral:
  ...
  - All morally neutral alignments: +1 Damage, +1 to Saving Throws, +5% Magic Resistance
  - True Neutral: +1 Armor Class, +1 to Saving Throws, +5% Magic Resistance, +5% critical hit chance with all weapons

The rest stays the same. Side note: the THAC0 bonuses it grants against alignments (this is vanilla behavior) are universal and do not apply only to The Equalizer, so if you put the weapon in your off hand and then use something else in your main hand, that weapon will still benefit. This can be a way of optimizing THAC0 against, for instance, Chaotic Evil targets such as Demogorgon when using a character that can dual-wield effectively.
...
This makes it useful for far longer, and more like the Sword of Mordenkainen. Additionally, drawing inspiration from the "dancing" aspect, it gains extra features based on the idea that the sword can dance on its own while being wielded, almost as if it were sentient:

- +1 Armor Class, +2 against piercing and slashing
- Speed Factor: 1
- THAC0: +4
- It is a flashy sword, and kits associated with flashy fighting get an extra +1/2 APR: Blades, Shadowdancers, and Swashbucklers

### Make Short Sword of Mask +5 slightly more powerful (1230) (BG2EE EET)
...
Just as the title says. It is kind of funny, considering that the weapon's description mentions Pit Fiends, which are Lawful Evil. It also makes the Dispel Magic charge ability equal in power to those on the Staff of the Magi and Carsomyr. Both changes are optional.

### Make Yamato's passive abilities more substantial (1250) (BG2EE EET)

The effect is pretty underwhelming for a +4 weapon. Since it is presented as a defensive weapon, the Armor Class bonus is improved to 2 (instead of 1), plus 1 against slashing, piercing, and missile attacks. It also grants 5% universal damage resistance and 5% Magic Resistance.
...
- The chance of dealing 2d10 electrical damage is increased to 15%, and the damage is now 5d4+1, with a Save vs. Spell at -2 for half
- Every hit deals 1d3 electrical damage with no save allowed
- Increases electrical damage resistance by 40% while equipped

### Make Spectral Brand slightly better (1270) (BG2EE EET)

This makes the summoned blade last for a full turn instead of 4 rounds. Additionally, the Armor Piercing charge ability now also improves damage by +4, increases critical hit chance by +10%, and makes critical misses impossible (effectively impossible unless something is increasing the chance of a critical miss).

### Make Dak'kon's Zerth Blade behave as a +3 weapon (1315) (BG2EE EET)
...
This component changes the healing to a probability-based system: a 50% chance to heal 1 HP, a 20% chance to heal 2 HP, a 15% chance to heal 3 HP, a 10% chance to heal 4 HP, and a 5% chance to heal 5 HP.

### Make Drizzt's weapons slightly more worth stealing in BG2 (1550) (BG2EE EET)

By the time you get these weapons in BG2, they are generally underwhelming, and you likely already have better ones. This improves them in a few ways, while trying not to stray too far from the lore:
...
- Twinkle: It has a defensive theme, therefore it now adds a +2 Armor Class bonus against slashing, piercing, and missile attacks, +1 Save vs. Spell, and +8% physical damage resistance.

### Make Hawksight slightly more passively powerful with a unique description (1580) (BG2EE EET)

This component takes the theme of speed and accuracy more seriously, and hence, other than granting +1 Dexterity, it also:

- Has +4 THAC0 bonus instead of +2
- Universal +1 Saving Throw bonus
- +1/2 APR

Optionally, it also adds a description worth reading (YMMV). I really dislike items with unique names but no interesting description or brief backstory. It feels lazy and uninteresting to add a named item without any background. Additionally, it adds a minor power to the weapon based on this brief backstory.

### Make Vexation more powerful (1582) (BGEE BG2EE EET)

I've always liked this sword conceptually, and it is introduced into the game in a very cool way. This makes the short sword another +3 weapon and additionally improves it in the following ways:

- Critical hits inflict 2d4 extra piercing damage
- Bleeding on hit improved from 1 to 1d2
...
I really hate unique items with nothing in the description worth reading, so I tried to add something more worthwhile. For reasons described in the description, it is now called Kachiko's Whisper. The following additions are included:

- Confounding whisper: Wisdom -2 penalty lasts for 6 rounds now as opposed to 2 rounds.
- Shadowdancers receive +10% to hiding skills and +1 THAC0
- Can cast Shadow Blink three times per day: instantly teleport to a visible location, become invisible for 2 rounds, and become unable to critically miss for the duration. Shadowdancers, Monks, and Stalkers get a +1 bonus to their backstab multiplier for the duration.
...
The Brass Blade is an unused weapon that lets you throw a Fireball as per the 3rd-level wizard spell, and it is tied to caster level, which means only Fighter/Mages can take full advantage of its power. Other classes would throw a much weaker Fireball. This changes the ability so that it instead casts a Delayed Blast Fireball at maximum level, and also adds the ability to cast Sunfire. It also reduces the fire damage on hit from 10 to 5, since that was a little overpowered, and fixes that damage being able to bypass Mirror Image.
...
This makes the weapon more interesting by replacing the simple +1 fire damage with:

- 1d3+1 fire damage on hit
- Can cause the target to catch fire, dealing 1d3 fire damage per round for 3 rounds if a Save vs. Spell is failed

### Make Water's Edge unique in function (1588) (BG2EE EET)

The unique description without any unique functionality bothers me, therefore:

- Grants +20% cold resistance while equipped
...
- +5% critical hit chance with this weapon
...
This weapon is not even a normal +4 weapon, since its speed factor is not 0 as it normally should be. This is a bug fixed by the Fixpack, and also by this mod automatically. Therefore:
...
You get this weapon fairly late in BGEE, and it is underwhelming. Also, "cold-using creatures" only includes winter wolves. The description is overly generous, because there is not much point in calling them "cold-using creatures" if it only means winter wolves. Here are the changes:

- Behaves exactly as a +2 weapon
- Deals by default +2 fire damage on hit
- The following creatures are now also considered "regenerating": planetars, dark planetars, solars, and fallen solars. The sword will act as if it were +3 or +4, respectively, for the purpose of hitting these creatures. There may be others that would qualify as "regenerating," but I am not sure.
...
This standardizes the swords as either long swords or bastard swords. They now also gain the following:

- They act by default as +2 weapons, and as +4 weapons vs. all shapeshifting creatures, including druids, dragons, and rakshasas.
- Deal +4 magic damage against those creatures
- Increases Magic Resistance by 7% and Save vs. Spell by +2

You have the option to choose which sword type to standardize them to, and also whether they should be renamed as in BG3. It is all in the preferences file.
...
The bonuses of this weapon are very significant, and it is an infamous tool for powergaming and no-reload runs. I reduced the resistances to 10%. They are still significant, while reducing the chances of breaking the game. Quantity can be overriden in the configuration file.

### Make Krotan's Skullcrusher slightly less generic (1311) (BG2EE EET)

Yet another enchanted, unique weapon without any special trait of any kind. It now possesses the same bonus as Skullcrusher in the vanilla game: a +2 damage bonus against humanoids.
...
I think everyone agrees that this type of restriction (Free Action) makes the weapon immediately less appealing. It will not reset your character's movement speed either. A side effect of this component is that the Free Action spell no longer sets movement speed to the baseline. The description was adjusted to reflect that.

Finally, it nerfs that ridiculous Slow effect so that it lasts 2 rounds and requires a Save vs. Spell to trigger, with the penalty improving as the flail becomes more powerful.
...
This exists simply because I hate that it is identical to Ashideena. So, inspired by the description, it now has a neat bonus against giant humanoids: on hit, they are stunned for 1 round if they fail a Save vs. Spell at +2. Additionally, the electrical damage on hit is 1d2 instead of 1, so it is very slightly more effective as a general-use weapon compared to Ashideena.

### Make Club of Detonation better and its fireball power class-agnostic (1327) (BG2EE EET)

The Club of Detonation is a fairly inconvenient weapon to use, as the fireball is presented as a detriment, and the upgrade even reduces its chance to trigger. It was reworked as follows:
...
- Speed factor was also modified to take enchantment levels into account, as generic enchanted weapons do
- The chance of triggering on the +5 version was increased from 5% to 10%, as the club is no longer conceived as something that may inconvenience the user randomly with a fireball. It is now just good news for your party and bad news for your enemies.

### Make Storm Star more shockingly electrifying (1328) (BG2EE EET)

This makes the weapon more interesting in the following ways:

- The +4 version improves electrical resistance by 20%, and the +5 version by 40%
...
This makes those very expensive darts much more likely to affect targets, which is a fair compensation for their rarity and high monetary cost. Save vs. Death is now at -4 (unless overridden in the configuration file). Additionally, they cause 1d2 poison damage on contact.
...
The +5 version literally just increases the THAC0 bonus by 1. Nothing more. So now it is reworked as follows:

- The +5 version increases the movement bonus to 5 (from 2).
- The +5 version adds a damage bonus of 1, as if it were a composite bow
- Both versions deal 3 or 5 extra damage to living non-humanoids and apply a small debuff if the target fails a save, reducing Armor Class, Saving Throws, and movement speed for 2 rounds.
...
This follows the anti-wizard theme of the description, and thus the following changes were added:
...
The description states that 30% of the target's health will be lost by the time the poison has run its course, but that is not actually true. Therefore, it now deals 30 points of poison damage over 30 seconds, similar to Bolts of Biting but slower. Additionally, these arrows have a 5% higher critical hit chance.

This will in turn make Hobgoblins and Sirines in BGEE significantly more dangerous if they land the poison on you, since -30 HP is a big deal in BGEE. Keep the antidotes and healing ready (my potion, cure poison spell, and healing spell overhauls help, wink wink).
...
This makes the arrows cause at least 3 extra piercing damage when the save succeeds. This should make these expensive arrows feel less wasteful when used, especially against targets with good saves. Additionally, these arrows have a 10% higher critical hit chance. Magic resistance is also not affected. It also standardizes them to behave as +3 weapons for the purposes of what they can hit, like in IWDEE.

### Make Bolts of Biting slightly more deadly (1347) (IWDEE BGEE BG2EE EET)

This improves the bolts slightly by adding direct poison damage, which may be useful for interrupting casters, and helps compensate for the lack of enchantment or THAC0 bonus. Additionally, these bolts have a 5% higher critical hit chance, since I envision them as assassin's tools.
...
My first move whenever I used Haer'Dalis was to give him swords that granted extra attacks. These are his personal swords, so it feels wrong not to use them. This makes them more appealing, since he will now have 3 APR by default when dual-wielding them. Both have a speed factor of 0.

Additionally, Entropy now causes 6 poison damage on a failed Save vs. Death at -1, instead of 3 damage with a save that has no penalties or bonuses. Chaos now reduces the struck opponent's saves vs. Death by 1 for 2 rounds. Both weapons can also hit targets immune to +2 weapons, such as balors.
...
- Entropy's Save vs. Poison penalty is -2, and it deals 9 poison damage
- Chaos's Saving Throw debuff is -2 and lasts for 3 rounds
- Act as +5 weapons
- Can only be wielded by Haer'Dalis

### Make Yoshimo's Katana more unique and powerful (1480) (BG2EE EET)

This component keeps to the idea that the weapon is only lightly enchanted, but it also offers a few advantages to Yoshimo only:

- Speed factor reduced from 3 to 1
- THAC0 bonus increased to 3.
- Increases proficiency points with katanas by 1
- +10% critical hit chance with the katana

### Make Mazzy's weapons more powerful (1500) (BG2EE EET)

Come on, Arvoreen! Be more generous to your most faithful holy warrior.

- Bow of Arvoreen grants Mazzy an extra +1/2 APR, +3 THAC0, and +1 damage
- Sword of Arvoreen grants Mazzy an extra +1/2 APR, +4 THAC0, and becomes a +3 weapon in most respects, except that it can still hurt enemies immune to +3 weapons
- Only Mazzy can wield them
...
Just a simple buff to make the shield a good option for longer. This also automatically applies the changes to this item from Component 1644.
...
This makes these abilities generate more items. Jan Jansen will create 10 Bruiser Mates. Eldoth will create 15 poisoned arrows. Additionally, his poisoned arrows will deal 20 poison damage over 40 seconds instead of 13.

### Make Nalia's ring more powerful (1642) (BG2EE EET)
...
- +20% bonus to Pick Locks and Find Traps (compensates for fewer Thief levels compared to Imoen)
...
This makes the blade grant Valygar the following benefits:
...
### Make NPC gear no longer bound to unnecessary stat restrictions (1644) (BG2EE EET)

The stat restrictions are a remnant of an older, inferior way of making the gear usable only by those NPCs... unless, of course, you happen to have the exact same stats as they do. This removes these restrictions, though only from the items where they seem too arbitrary:
...
The rest seem less arbitrary: Jan Jansen's special gear requires 17 Dexterity, i.e. the ability to handle it; Mazzy's has no special restrictions; Haer'Dalis' has no special restrictions; and Yoshimo's has no special restrictions.
...
Overall, this will complement his werewolf shapes and druidic traits. Obviously, this was made with the assumption that he's a shapeshifter and not any other kind of druid, though it's unlikely to break anything unless he's a fighter/druid, perhaps due to the stacking of physical resistances.
...
Deathbringer assault is a bit stupid. Yes, it's very cool. Yes, big ToB bosses are not affected. And it triggers only 3% of the time. But it's still 200 slashing damage, without even a save to take only half. Sarevok also causes stun, even though it's supposed to be a fear-induced state, 11% of the time when he hits, for 2 rounds, which is almost always a death sentence when it happens. It also cannot be dispelled, as it is a natural effect. The following changes are applied:

- The damage part of the assault is now 120, overridable in the config file, and allows a Save vs. Death at -5 to take half. 60 damage is still a BIG FAT hit, added on top of a regular hit, so... you'll be fine
- Golems, other constructs, slimes, spiritual beings, spectral undead, and dragons are all immune to the damage no matter what
- The stun is meant to be an effect of fear, not a "stun" per se, and as such, it is no longer a stunning effect, but a fear effect that roots the enemy in place and inflicts a -10 penalty to their Armor Class. Only creatures that are not immune to fear will be affected by this.
...
Fair warning: as with all abilities with a cooldown, DO NOT use CTRL+R on Hexxat while it's on cooldown, as it may cause her to lose the ability entirely, since it destroys the effect that **returns** the ability to her.

### Make Edwin's amulet nuanced in the privileges it grants to that snake (2250) (BGEE BG2EE EET)

There are no words to express how much I hate that Edwin is the best wizard to have along because of the absurdly overpowered amulet he has. He, like Haer'Dalis, represents another one of those instances I hate: an NPC who is always going to be better than CHARNAME in their class or kit. So now the item gives him something a bit more nuanced:
...
### Make Finger of Death's magical damage on a successful save standardized (140) (BGEE BG2EE EET)

This component matches the magic damage inflicted by the wizard version of Finger of Death to that of the priest version.

### Make Luck last longer and benefit more (145) (IWDEE BGEE BG2EE EET)

The bonus that Luck provides really doesn't justify such a short duration. Now it lasts 1 turn instead of 3 rounds, i.e. 18 seconds, and becomes generally more useful by also adding a 5% critical hit chance boost, a 10% total thief skill bonus, as well as 2 Armor Class. The rest is unchanged. You can choose which parts of the component you want to install in the configuration file.
...
Technical details: this sets the backstab multiplier to 0x. It would be possible to make them backstab again if you had effects that increased backstab multiplier. So if you were a level 21 assassin and shape-shifted into an iron golem, your backstab multiplier would change from 7x to 0x, and if you then added an item that increased it by 1 and cast an ability that increased it by 2, your backstab multiplier would become 3x, even as an iron golem.
...
I think the damage is a little low for a 4-round static effect, 2-16 cold damage per round. Now the damage will be 2d8+2 cold damage plus 1d6+2 piercing damage. Piercing was added because the animation indicates that pointy ice is what falls down upon your foes. IWDEE's version is completely different and so it is untouched.

### Make Ray of Enfeeblement a Necromancy spell (370) (IWDEE BGEE BG2EE EET)

It probably makes more sense to make this spell a Necromancy spell, as in NWN and NWN2.

### Make Contagion cause 4 points of Strength and Dexterity damage (380) (IWDEE BGEE BG2EE EET)

2 points of damage to STR, DEX, and CHA is underwhelming, and CHA reduction is irrelevant unless using particular mods. Now it reduces STR and DEX by 4, which should be a little more meaningful and more worth the level 4 slot.

### Make Death Fog better and closer to PnP somewhat (390) (BGEE BG2EE EET)

The spell is now 'Acid Fog' and is inspired by PnP. It no longer kills summons. Instead:

- 2d8+4 points of acid damage (double for plants and myconids)
- Once every three roudns, -4 AC, their physical damage resistances -15%, acid resistance -30% for 1 turn after being exposed
...
I think this makes the spell much more useful, although perhaps it's too powerful like that if used against some enemies. Additionally, minotaurs are immune to it, same as in IWDEE. It will also prevent movement while the animation plays out. It also patches the shadowdancer version to behave the same way, unless my shadowdancer overhaul is installed, which changes the animation entirely and the mazing is instant the moment they're hit.
...
This makes the spell achieve a THAC0 of 0 at max level, since the description clearly states "fighter of the same level." It also grants +1/2 APR at levels 7 and 13. This APR does not stack with the one provided by Holy Power (Component 190).

Finally, by default, it will grant APR only to non-fighter casters, as fighters already have the APR they need. This can be disabled in the configuration file.

### Make Flesh to Stone and Stone to Flesh more unique (444) (IWDEE BGEE BG2EE EET)

This overhauls these two spells, both optionally, in the following ways:

- Flesh to Stone: This makes the spell force a Save vs. Petrification instead of a Save vs. Spell. I think Flesh to Stone and Disintegrate are far too similar functionally, and it is almost always a better idea to use Flesh to Stone over Disintegrate, especially since both are boosted equally if cast by a Transmuter. This affects the version that beholders use as well. Additionally, you can choose in the configuration file to add explicit exceptions to this spell, as in IWD, such as elementals and spectral undead.
- Stone to Flesh: This spell should affect stone golems as per PnP, making them lose their weapon immunities permanently if they fail their Save vs. Spell. All weapons, enchanted and unenchanted, will then be able to affect them.

Note for users and modders: The Stone to Flesh spell tweak is implemented somewhat naively, since it relies on them using the `IMMUNE2.ITM` item to provide their immunities. If some other item does that, this might not work. This seems to be the preferred approach in the vanilla files regardless. This tweak will also try to strip immunities embedded in the creature file itself, but it will not target other things that might provide part of their immunities, such as their weapons. If you try this, let me know if you notice anything strange.
...
This modifies the projectile, making it spread faster to enemies. Additionally, the damage is now 5d6 plus 1d6+1 per 2 levels, increasing up to 15d6+10 at level 20. Both things can be freely allowed or disallowed through the configuration file.
...
This improves the spell and the abilities it grants in the following ways:
...
- Eye of the Sword: Instantly casts 3 Magic Missile spells instead of just one
...
### Make Control Undead bypass Magic Resistance and have a -2 penalty to the Saving Throw (500) (IWDEE BGEE BG2EE EET)

Generally considered a terrible choice for a level 7 spell, this makes it a little more useful. I might make it more powerful in the future, but for now, it bypasses Magic Resistance and the Saving Throw has a -2 penalty. Just the fact that it did not bypass Magic Resistance was a big detriment to the spell, since many undead are resistant to magic, like the majority of skeletons.
...
I think this makes more sense, and the spell is pretty overpowered for a level 2 spell, given that paralyzing effects are often a death sentence. I actually think many spells should force a Save vs. Breath rather than a Save vs. Spell. This mirrors what I did for Entangle.

This change to the save bonus does not affect special abilities outside the spells themselves, such as spider abilities.
...
This makes the sword behave as +2 against undead. For technical reasons, this will make the weapon no longer count as non-magical. Finally, it doubles the duration of the spell in BG. Additionally, it doubles the fire damage it inflicts in the IWDEE version.

### Make Bless and Curse last longer and increase the casting speed from 6 to 3 (110) (IWDEE BGEE BG2EE EET)

It's not worth casting due to the short duration and the long casting time. To improve this, both now last 6 rounds plus one extra round every two levels, and they cast faster.

### Make Hold Person Saving Throw penalties standardized at -1 (130) (IWDEE BGEE BG2EE EET)

This component equalizes the Saving Throw penalty in the cleric version of Hold Person so that it matches the wizard version, which is -1.

### Make Holy Power grant a THAC0 of 0 at max level and APR at the appropriate levels (190) (IWDEE BGEE BG2EE EET)

This makes the spell achieve a THAC0 of 0 at max level, BG only, since the description clearly states "fighter of the same level." It further tightens the gap between the cleric and the fighter they want to emulate, granting +1/2 APR at levels 7 and 13. This APR does not stack with the one provided by Tenser's Transformation (Component 441). By default, non-fighter classes are the only ones getting the extra APR. This can be disabled in the configuration file.
...
This uses the same filename and the same effect as in IWDEE, and it attempts to patch known spells that remove fear effects. It might need to be updated if new ways to remove fear are introduced.
...
Finally, because Earthquake has this silly behavior where the sound of the quake triggers for every affected creature, it will now ring only once every time it triggers, using the caster as the center point of the sound.

### Make Negative Plane Protection's duration increase somewhat as you level up (260) (IWDEE BGEE BG2EE EET)

It only lasts 5 rounds, which is insufficient for fights with vampires. Since it is a very powerful effect, the increases in duration are moderate: one round per 2 levels, up to 11 rounds at level 20.

### Make Entangle more powerful and relevant for druids and shamans (270) (IWDEE BGEE BG2EE EET)

Entangle saves are quite generous for targets and, as such, very difficult to make relevant at higher levels. It is such a hallmark ability for druids that it feels wrong to leave them without it because it becomes useless so quickly. Additionally, the Armor Class debuff improves to -3 and limits APR to 1 while the character is held by the vines. It also makes creatures that are too big or have unusual qualities immune to it, such as dragons, shadows, and slimes.
...
It also changes the Saving Throw from Spell to Breath and makes it bypass Magic Resistance, though it can still be dispelled.

Finally, in BG2EE, it also replaces the HORRENDOUS sound while it is active in the field with BGEE's version, which is much more tame and less annoying.

### Make Poison spell do half damage on a failed save (280) (BGEE BG2EE EET)

See Component 100 for the reasoning.

### Make Iron Skins cast as fast a Stoneskin (300) (BGEE BG2EE EET)

This component reduces the need to use it only in pre-fight buffing rituals due to the extremely long casting time. In IWDEE, this feature is already present.
...
Additionally, much like in IWDEE, blinded enemies are not affected, which is to be expected given the nature of the spell. Finally, it can be configured so that True Sight prevents the effect, since it is an illusion.

### Make Cleric's level 7 version of confusion act like Chaos (330) (IWDEE BGEE BG2EE EET)

It was always a fairly odd choice for a level 7 spell. Some mods resolve this by moving it to lower levels. This is another way of resolving it. It will behave like Chaos, having a save penalty of -4 instead of -2.
...
This makes Bolt of Glory generally more effective and rearranges the damage so that outsiders and undead are always ahead in potential damage compared to Prime Material creatures. Additionally, the description more accurately notes other lesser-known characteristics of the spell, such as that it has no effect on celestial beings (planetars, devas, solars, aasimar) and that it bypasses Magic Resistance. Here's the damage distribution now:
...
- Fiendish outsiders, including fallen planetars, devas, and solars: 8d8+6 magic damage

### Make Magical Stone bypass Magic Resistance and deal both magic and missile damage (462) (BGEE BG2EE EET)

Generally, this spell is pretty worthless and barely worth thinking about. This improves its usability by making it bypass Magic Resistance, since it is essentially a pebble enchanted to be thrown at an enemy. It now deals 1d4 missile damage and 1d4 magic damage. It will also scale with level, dealing 1d6 missile and magic damage at level 3, and then 1d8 missile and magic damage at level 5.
...
- For the poison's duration, the target takes 8% more physical damage and gets a -2 penalty to THAC0, damage, and Armor Class

### Make Wondrous Recall also recall wizard spells, and a higher number of them (464) (IWDEE BGEE BG2EE EET)

This component allows cleric/mages to benefit more by allowing arcane spell recall. The spell now functions as follows:

- Guarantees the recall of 2 level-1 wizard **and** cleric spells
- Four more spells will additionally be recalled, of up to level 5

However, the casting time is now very high, 2 full rounds, which makes it less convenient to cast in the middle of combat and makes it more of a post-combat recovery spell, unless triggered by contingencies or sequencers. Bear in mind that if this spell is cast through scripts, the caster might have a lapse in judgment and stop the casting after only one round to do something else, because it seems the engine does not expect casting times over just below 1 full round, i.e. a casting speed of 9.

### Make Shield of Archons absorb more spell levels and closer to PnP (466) (IWDEE BGEE BG2EE EET)

This component improves the spell such that it has a spell absorption level equal to the cleric's level, 20 in BG and 30 in IWDEE. Additionally, to remove the alignment connotations, it changes its name to Planar Shield, since archons are good-aligned celestials. Finally, following PnP, it also gives the user a +4 Saving Throw bonus against all non-absorbable effects.
...
- 6d6 damage to undead for a level 6 spell (you might as well use Sunfire if available; it causes more damage, even if it does not cause Confusion for 12 seconds)

The solution I propose:

- Casting speed is now 4, equal to Sunray
- The damage is no longer blocked by magic damage resistance and instead deals 5d6 fire damage and 5d6 magic damage (originally 6d6 fire damage)
...
- You can cheese incredibly powerful creatures like liches far too easily. It is stupidly powerful, even though liches are cadaverous undead that are not actually sensitive to sunlight and cannot be destroyed by it.
...
This solution follows 2nd edition more closely, where only undead specifically sensitive to light may be destroyed by it. Spectral undead are generally weakened, but not destroyed; vampires, vampyres, and vampire spawn can be utterly destroyed; and other cadaverous undead are neither weakened nor destroyed, including liches and demiliches, though the latter are essentially immune to all spells anyway, including Sunray.

### Make Call Lightning's damage and scaling more balanced (468) (BGEE BG2EE EET)

This component rebalances the spell to provide smoother damage scaling and makes it bypass Magic Resistance, as it is a natural effect brought by the druid.
...
None of these effects are subject to Magic Resistance, though this is a level 5 effect, and thus liches are unaffected.
...
- The damage is the same, but the minimum damage has been increased: evil targets take 2d8+4 magic damage, instead of 2d10, and undead additionally take 3d8+6. This damage is no longer affected by Magic Resistance.
...
This makes the spell generally more useful by turning it into a party buff. To avoid issues with combat scripts, the targeting remains vanilla: Aid is cast on a target, and then it spreads to nearby allies. Also, for convenience, the range of the spell is no longer melee, but equivalent to that of Poison. It also adds a maximum HP buff of +1 HP per level after level 5, up to a maximum of +17 HP on top of the usual 1d8 from the Aid opcode.
...
Self-explanatory, plus it makes sense that these spells should be able to restore the damage done by such creatures. Currently, there is no way to cure this other than by waiting. The Greater version of the spell, in its Wish form, will no longer cause fatigue either.

Optionally, it can overhaul the Greater Restoration spell so that it is more worth the slot, with some disadvantages for balance:
...
- It still causes deep fatigue on the caster, and worsens the priest's casting speed, THAC0, damage, and Armor Class by 2 for 2 turns. Their movement speed is also reduced by 35%. All of these effects can be removed with Unfailing Endurance.
- The casting duration is tripled (9 from 3).

### Make Silence 15ft Radius party-friendly (509) (IWDEE BGEE BG2EE EET)

Self-explanatory. This makes it easier to manage.

### Make Righteous Wrath of the Faithful slightly better (510) (IWDEE BGEE BG2EE EET)

The attack damage bonus is missing for same-alignment allies, unlike what the description says. This fixes that. Additionally, it now causes only 4 points of fatigue, similar to Haste, so it is a bit less inconvenient to use. Finally, this fatigue can no longer be dispelled, same as Haste, which is likely a bug not yet addressed by the devs or the Fixpack.
...
Alicorn Lance is not very powerful and does not scale well. This will make it more feasible at higher levels.
...
- Optionally, it does not harm allies, though it can still harm neutral targets. On by default

### Make Static Charge electrocute twice as often, but for half the damage (479) (IWDEE BGEE BG2EE EET)

This makes the spell trigger twice per turn, i.e. every 5 rounds / 30 seconds, instead of once per turn. It reduces the number of dice rolled by 5, such that it starts off dealing 4d8 electrical damage and increases up to 17d8 at level 20. To me, the higher frequency is more useful than the higher damage. Most fights do not last long enough for the damage to become relevant.

### Make Cloudburst last longer and less horrendously bad (485) (IWDEE BGEE BG2EE EET)

- Effects are no longer subject to Magic Resistance
- Damage effects no longer affect non-enemies, but other effects, such as dispelling fire shields, still affect friendlies
- Electrical damage increased to 2d8+2, with no save for half
- The probability of taking a bolt of lightning is increased from 50% to 65%
- Extra damage versus cold- and fire-immune creatures is doubled, to 4d3 magic damage. Friendlies are still affected.
...
- Scales with level, increasing damage by 1d12 every two levels, up to 6d12 at level 11
...
- -15% fire resistance
- +2 Armor Class against crushing, +1 against missile and piercing
...
For balance, this component also makes Barkskin unavailable to clerics and paladins, and Shield of Faith unavailable to druids.

Finally, the component also updates the Staff of the Woodlands to reflect these changes, although it does not grant the one-layer Stoneskin effect. The Armor Class is also set to 1. Barkskin cannot be cast on oneself while holding the staff either.
...
- Unaffected by Magic Resistance
- Damage doubled: 2d8 slashing and 2d8 crushing becomes 4d8 slashing and 4d8 crushing
- No limit on the number of creatures damaged, and no protection against it after being hit once for 1 round

### Make Produce Fire a much more effective spell (497) (IWDEE BGEE BG2EE EET)

Produce Fire is not very effective for a 4th-level spell. The only upside is that the damage it causes is predictable, being 1 point per level plus 1d4, without any Saving Throw for half damage. However, the damage is too low to be useful. This component improves the spell by simply allowing targets in the area of effect to be affected once every 2 seconds, effectively taking around 60 fire damage at druid level 20 if they remain in the area for the full duration.

### Make Aura of Flaming Death increase fire resistance instead of setting it to 90% (515) (IWDEE BGEE BG2EE EET)

Self-explanatory. This will also prevent some nonsense, such as creatures immune to fire suddenly becoming no longer immune if they cast it, as in the case of some fiends.
...
- Slays anything of level 3 and below (vanilla), but also creatures with 40 Hit Points or less with no ways for them to resist other than immunity to death effects, such as with Death Ward
...
This increases the chance of causing panic in enemies by forcing a Save vs. Spell at -2. Additionally, since panic is usually disliked because it is difficult and tedious to attack running targets, it also halves their movement speed, making it far less inconvenient.

The war cry also rallies the allies now, causing the following effects:

- The warrior and their allies are healed by 12 HP, their morale is restored to its maximum, preventing and removing morale-based panic, and for 3 rounds they get a +2 bonus to THAC0 and damage.
- The warrior also gets, for the same duration, a +5% chance to critically hit.
...
- **Assassination**:
  - Duration of backstab on every hit increased to 7 seconds. The other effects last 2 more rounds.
  - For the duration and for one round after, grants immunity to critical misses and +10% critical hit chance.
...
I do not find abilities that tap into "inner strength" or pure skill-based physical abilities to be valid candidates for Breach. If they are not dispellable, then they are not breachable either. What exactly is the spell supposed to be dispelling? The following abilities are no longer breachable:

- **Evasion and Improved Evasion:** You are concentrating on your epic dodging skills as a rogue, using your training and experience. Can you "breach" reflexes and experience? No!
- **Assassination:** You are using your training to strike weak points in a superior manner, exerting such amazing skill that you always succeed, even if the target is not hit unexpectedly. Can you breach assassination skills? No!
- **Avoid Death:** You are using your training and nigh-preternatural roguish luck to escape terrible odds and stubbornly survive. Can you breach luck and survival skills? No!
...
### Make Quivering Palm's slightly better and scale with level (2160) (IWDEE BGEE BG2EE EET)

I really dislike things that scale poorly or not at all. This makes Quivering Palm's Saving Throw penalty improve to -1 at level 16 and to -2 at level 24. Additionally, the effect lasts 7 seconds, up from 5 seconds, to give more leeway.

### Make the THAC0 progression of Thieves and Bards better and more streamlined (2170) (IWDEE BGEE BG2EE EET)

Among the many manifestations of the Baldur's Gate series' undying hatred for thieves and bards is that their THAC0 sucks. A LOT. Barely better than wizards. This improves the progression so that it can reach 6, like clerics. The progression per level follows this sequence: 20-19-19-18-17-17-16-15-15-14-13-13-12-11-11-10-9-9-8-7-7-6.

This component updates the THAC0 of Bards, Thieves, and Mage/Thieves in the game depending on their level, but only if it is not better already.
...
### Make Blackguards able to backstab as if they had a 2x multiplier (2200) (IWDEE BGEE BG2EE EET)

Self-explanatory. It will also patch any Blackguards in the game so that they are guaranteed to be able to backstab if they possess an eligible weapon and somehow can go invisible and attack (one such case exists in SoD, at least).

### Make Shadowstep impossible to use while in the Shadow Plane (3500) (BGEE BG2EE EET)

This seems more like a bug fix than a tweak, but it bothers me, and it is not tackled anywhere else, so here it is. No one can cast Shadowstep during those sequences, since those abilities rely on a brief plane shift to the Prime's parallel plane, the Plane of Shadow. This needs to be patched manually, and only Rasaad's ToB quest areas and Lava's Shades of the Sword Coast Gnoll Stronghold variant are affected. This is compatible with my Shadowdancer overhaul.
...
Note that this component does not patch their kit descriptions, as it is not intended to be a kit overhaul, but rather something to add onto whatever you already have available.

### Make Defensive Spin protect against backstabs for its duration and allow very slow movement (2265) (IWDEE BGEE BG2EE EET)

This is a straight upgrade to the ability, since disabling movement is highly inconvenient. Immunity to backstab is just an extra nicety that may sometimes be useful, especially if defensive spells are unavailable. Movement rate is set to 50%; Boots of Speed would set it back to baseline, for example.
...
Additionally, Improved Evasion, now just Evasion, triples the movement speed granted, factor of 6 instead of 2, and makes it use opcode 176, so it is not removed by Free Action. There are options in the configuration file to select only one of these changes, if desired.

It affects all classes and kits, including modded ones. It only affects HLA tables that have *both* the basic and improved Evasion available. This means that the Swashbuckler, for example, will not be affected by the Whirlwind Attack part, since it has access only to the lesser version.

### Make single-classed thieves and bards able to throw sand in the enemy's eyes (2280) (IWDEE BGEE BG2EE EET)

Just to add a new dimension to the fight-dirty toolkit of rogues. Also, because I want to promote specialization, this is available only to single-classed thieves and bards. Once per turn, you can throw sand into the enemy's eyes, causing very minor non-lethal damage and impairing them for up to a round if they fail a Save vs. Breath. Many powerful creatures are immune to this effect, but it offers a new thing to try once per turn. It is explicitly limited to single-class characters because they deserve the love.
...
This gives these classes (not multiclass thieves, you want the benefit of a second class, you already got enough), an ability they can use to avoid projectiles and most AoE spells and dragon breaths. This lasts for 23 ticks, around one and a half seconds, which means it should be used *as you are about to be hit by it*. The full list of abilities and spells is: all Fireball spells and abilities, all basic projectiles, arrows, bolts, throwing weapons, etc., all dragon breaths, and the spells Dragon Breath, Comet, Produce Fire, Smashing Wave, Thorn Spray, Skull Trap, Glyph of Warding, Holy Smite, Unholy Blight, Burning Hands, and Cone of Cold.

Thieves and bards get this ability at level 7, and monks get it at level 4. For balance, it is usable only once per rest and, as mentioned, its duration will likely be enough to avoid only one effect, or more if they all happen to strike at around the same time.

### Make Defensive Stance slightly more balanced (2300) (IWDEE BGEE BG2EE EET)

This component rebalances the power slightly:

- It now also adds +2 Armor Class, not just Saving Throws
- Movement rate penalty reduced to 40%
- -1 penalty to THAC0 and Damage
- -1/2 fewer attacks per round. For example, at the start of the game in BGEE, this would force APR down to 1 when fighting with only one weapon, and after level 13, it would be reduced to 2 APR, all other things being equal.
...
- Targets may be affected by a crippling strike only once every 5 rounds; repeated backstabs do not refresh the duration.
- A helpful console string will appear when one is successfully applied.
- Constructs, undead, mist creatures, oozes, shambling mounds, and elementals are unaffected.

Do not mix this with Sneak Attacks; use it only if you are planning to use backstabs.
...
This component makes summoned demons grant party XP. It may not catch every instance of a kill, such as when enemies die in groups from fireballs and similar effects, because their combat script might not be able to cope with it. Obviously, do not install this with fiend overhauls that already add this behavior.

Also, pay attention to any mods that modify the behavior of summoned demons, especially if they replace the script. This might or might not work. Please test and report.
...
- Removing artificial health for a fighter of his level. Health will now be 105 plus the Constitution bonus, which, unless a mod changes how Constitution works, means 105 + 45 = 150
- Removes the extra APR, so he will have 2.5 APR, as expected for a level 14 fighter according to his proficiency and fighter levels. This may of course vary if mods change the fighter classes
...
This component makes beetles generally more resistant to anything that does not crush them. Arrows and bolts bounce off more often, and attempts to slash or pierce their carapaces are not very effective. Their resistances follow this pattern:
...
### Make Yuan-ti slightly more powerful (3110) (IWDEE BGEE BG2EE EET)
...
- **Magic** golems: 27% of the non-physical damage they take is always absorbed as healing.
- **Adamantite golems**: Normally identical to Iron Golems, except with 70% higher physical resistance, they're now slightly more powerful. They are, according to lore, *almost* impossible to defeat. Therefore:
  ...
  - They can stomp the ground, causing it to tremble, knocking down all non-flying, up-to-medium-sized creatures in a 30-foot radius and dealing 5d10 crushing damage, with a Save vs. Breath at -4 for half damage and to avoid unconsciousness. Trying to run away to block their path triggers them to use this ability.
...
Most minotaurs are wimps in the game. This is what it changes:
